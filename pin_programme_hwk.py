...
for attempt in range (attempts):
    ...
    if supplied_pin == correct_pin:
        print (f"access granted. You suceeded in {attempt +1} attempt")
    ...
    # programme ends
    else:print (f"access granted. You failed access denied:{attempts -attempt -1} attempts left")

>>>>>>> 27d89828d8494a5380bd2739289b695870c1b8fc
